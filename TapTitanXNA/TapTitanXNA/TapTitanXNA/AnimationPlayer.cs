...
namespace TapTitanXNA
{
    struct AnimationPlayer
    {
        ...
        {
            get { return new Vector2(Animation.FrameWidth / 2.0f, 
                        ...
                        SpriteEffects spriteEffects)
        {
            if (Animation == null)
            {
                throw new NotSupportedException("No animation is currenty playing.");
            }
            ...
            spriteBatch.Draw(animation.texture, position, source,
